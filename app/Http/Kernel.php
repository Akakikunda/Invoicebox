...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // keep minimal; default middleware are provided by the framework
    ...
    protected $routeMiddleware = [
        ...
        'signed' => \App\Http\Middleware\ValidateSignature::class ?? \Illuminate\Routing\Middleware\ValidateSignature::class,
